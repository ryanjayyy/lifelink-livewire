            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <div class="w-lg-1500px p-10">
                    ...
                    <div class="stepper stepper-pills" id="kt_stepper_example_basic">
                        ...
                        <!--begin::Form-->
                        <form wire:submit.prevent="register" id="kt_stepper_example_basic_form">
                            <!--begin::Group-->
                            <div class="mb-5">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div>
                                    ...
                                    <button wire:ignore.self type="button" class="btn btn-primary" data-kt-stepper-action="next">
                                        Continue
                                    </button>
                                </div>
                                <!--end::Wrapper-->
