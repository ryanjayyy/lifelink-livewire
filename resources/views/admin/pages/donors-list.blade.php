...
<div class="w-100">
    <div class="d-flex justify-content-between align-items-center w-100">
        <div>
            <h1 class="fw-bold text-gray-800 mt-8 mx-4">Donors List</h1>
            <div class="card-header pt-5">
                ...
                <div class="card-title d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center">
                        <!--begin::Amount-->
                        <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2 badge badge-light-success fs-base">{{ $donorsCount }}</span>
                        <!--end::Amount-->
                    </div>
                    <!--end::Info-->
