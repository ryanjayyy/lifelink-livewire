                    ...
                    var t = { self: null, rendered: !1 },
                        a = function () {
                            var a = parseInt(KTUtil.css(e, "height")),
                                ...
                                s = {
                                    series: [
                                        { name: "Net Profit", data: [44, 55, 57, 56, 61, 58, 100] },
                                    ],
                                    ...
                                    xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: o, fontSize: "12px" } } },
                    ...
                    var t = { self: null, rendered: !1 },
                        a = function () {
                            var a = parseInt(KTUtil.css(e, "height")),
                                ...
                                s = {
                                    series: [
                                        { name: "Total", data: [44, 55, 57, 56, 61, 58] },
                                    ],
                                    chart: { fontFamily: "inherit", type: "bar", height: a, toolbar: { show: !1 } },
                        ...
                        a = function () {
                            var a = parseInt(KTUtil.css(e, "height")),
                                ...
                                h = {
                                    ...
                                    colors: [l, n, c],
                                    grid: { borderColor: r, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                                    markers: { colors: [i, d, KTUtil.getCssVariableValue("--bs-primary-light")], strokeColor: [l, n, c], strokeWidth: 3 },
                                };
            ...
            (function () {
                ...
                [].slice.call(o).map(function (o) {
                    (e = o.getAttribute("data-kt-color")),
                        ...
                        new ApexCharts(o, {
                            series: [
                                { name: "Stock", data: [80, 90, 100, 95, 90, 85, 100, 90] },
                            ],
                            ...
                            xaxis: { categories: ["BM Max", "Mouro Blend", "Softgel", "Buah Merah Mix", "ONA Coffee", "Revitan Set", "Redmint", "Ultra White"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: r, fontSize: "12px", } } },
                            ...
                            colors: [a, "#F6C000", "#FF0000"],
                            grid: { padding: { top: 10 }, borderColor: s, strokeDashArray: 2, yaxis: { lines: { show: !0 } } },
                        }).render();
                });
            })(),
            (function () {
