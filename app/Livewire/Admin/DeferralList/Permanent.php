...
class Permanent extends Table
{
    public $deferralCount;

    public function mount()
    {
        $this->deferralCount = DeferralList::where('deferral_type_id', 2)->where('status', true)->count();
    }

    public function render()
    {
        return view('admin.pages.deferrals.permanent')->extends('layouts.admin');
    }
    ...
    public function getQuery(): Builder
    {
        $sub = DeferralList::query()
            ...
            ->where('deferral_lists.deferral_type_id', 2)
    ...
    public function columns(): array
    {
        ...
        $deferralCategory = [];
        foreach (DeferralCategory::where('deferral_type_id',2)->get() as $row) {
